...
{
    public class InMemoryEventBusSubscriptionManager : IEventBusSubscriptionService
    {
        ...
        private void AddSubscription(Type handlerType, string eventName)
        {
            ...
            {
                throw new ArgumentException($"Handler Type {handlerType.Name} already registered '{eventName}'", nameof(handlerType));
            }
