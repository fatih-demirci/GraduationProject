...
const UniversityDetailPage = () => {
  ...
  useEffect(() => {
    ...
    universityServices
      .GetUniversityComment(params.id)
      .then((res) => {
        setUniversityComments(res.data.value);
  ...
  function submit(e) {
    e.preventDefault();
    universityServices
      .AddUniversityComment(params.id, stateTitle, message, file)
      .then((res) => {
        console.log(res);
  ...
  return (
    <div className="container">
      ...
      <div className="row ">
        {universityComments.map((res) => (
          <div className="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-sm-12 col-xs-12 mt-2 university-detail-page-shares-card-flex">
                  ...
                  <div class="university-detail-page-shares-card-content--container | flow">
                    <div class="university-detail-page-shares-card-content-title">
                      <p>
                        {res.Title.length < 12
                          ? res.Title
                          : res.Title.slice(0, 12) + "..."}
                      </p>
                      <p className="university-detail-page-shares-card-content-date">
                        {new Date(res.CreatedDate).toLocaleDateString("tr-TR", {
                          year: "numeric",
                          month: "long",
                          day: "numeric",
                          weekday: "long",
