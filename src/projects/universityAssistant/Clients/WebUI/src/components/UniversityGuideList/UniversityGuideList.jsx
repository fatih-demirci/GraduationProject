...
const UniversityGuideList = () => {
  ...
  useEffect(() => {
    universityServices
      .UniversityListFilterProvienceId(params.id)
      .then((res) => {setUniversityList(res.data.value)
      console.log(res);})
      ...
      <div className="row university-guide-info-div">
        {universityList.map((data) => (
          <div className="col-xxl-6 col-md-6 ">
            <Link
              to={`${data.Name.toLowerCase().replace(" ", "-")}/${data.Id}`}
            >
              <div className="university-guide-info">
                ...
                <div className="university-guide-text-div">
                  <div className="university-guide-text ms-2 ">{data.Name}</div>
                </div>
              </div>
            </Link>
          </div>
