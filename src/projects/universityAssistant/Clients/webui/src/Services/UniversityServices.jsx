    ...
    return axios
      .get(
        process.env.REACT_APP_API_URL +
          `/Universities/?culture=tr-TR&count=true&select=id,provienceId,provienceName,countryId,countryName,name,website,email,phone,fax,address,type,LogoURL&filter=provienceId eq ${provienceId}`,
