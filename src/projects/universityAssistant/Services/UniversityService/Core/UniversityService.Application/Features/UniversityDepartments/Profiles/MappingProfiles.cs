...
public class MappingProfiles : Profile
{
    ...
    {
        CreateMap<UniversityDepartment, GetAllUniversityDepartmentResponseDto>().ForMember(x => x.Faculty, y => y.MapFrom(z => z.Faculty));
        CreateMap<Faculty, FacultyDto>()
            ...
            .ForMember(x => x.Id, y => y.MapFrom(z => z.Id)).ReverseMap();

        CreateMap<UniversityDepartment, GetAllUniversityDepartmentResponseDto>().ForMember(x => x.Department, y => y.MapFrom(z => z.Department));
        ...
        CreateMap<UniversityDepartment, GetAllUniversityDepartmentResponseDto>().ForMember(x => x.University, y => y.MapFrom(z => z.University));
